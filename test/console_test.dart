...
void main() {
  group('URL conversion tests', () {
    test('converts GitHub URL to raw pubspec.yaml URL', () {
      ...
      const expected = 'https://raw.githubusercontent.com/user/repo/main/pubspec.yaml';
...
''';
    ...
    test('prioritizes dependencies over dev_dependencies when analyzer is in both', () {
      const yamlContent = '''
name: example_package
dependencies:
  analyzer: ^6.0.0
